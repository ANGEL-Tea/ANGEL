...
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس اينجل' or text == 'اريد بوت تمبلر' or text == 'سورس اينجل' then
Text = [[
•- DEV @EEEEEEB مبرمج بوتات•
]]
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس اينجل
احدث واسرع البوتات وضمان الثقه
للاستفسار راسل المطور @EEEEEEB
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevANGEL(msg) then
function Function_ANGEL(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevANGEL(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevANGEL(msg) then
...
database:sadd(bot_id.."ANGEL:flooding:settings:"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."ANGEL:flooding:settings:"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "• تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."ANGEL:flooding:settings:"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."ANGEL:flooding:settings:"..msg.chat_id_)
...
if text == "رفع امر" and Constructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع صلاحيه (.*)$") and Addictive(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "رفع رد" and Owner(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "رفع رد للكل" and DevANGEL(msg) then 
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
database:set(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:ANGEL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:ANGEL:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ANGEL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:ANGEL:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:ANGEL:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:ANGEL:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:ANGEL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:ANGEL:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and DevANGEL(msg) then
 
local list = database:smembers(bot_id.."botss:ANGEL:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:ANGEL:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"تم حذف ردود المتعدده")
end
if text == ("الردود المتعدده") and DevANGEL(msg) then
...
if text == "رفع رد متعدد" and DevANGEL(msg) then
 
database:set(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and DevANGEL(msg) then
 
database:set(bot_id.."botss:ANGEL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:ANGEL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ANGEL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ANGEL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:ANGEL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:ANGEL:Add:Rd:Sudo:Text2"..text)   
...
if text and text:match("^رفع مجوهرات (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Num = text:match("^رفع مجوهرات (%d+)$")
...
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '🚹 اشترك الان   ',url="t.me/FxxFx"}},  
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false 
...
⌔┇𝗌𝗈𝗎𝗋𝖼𝖾 ANGEL 𖤍
— — — — — — — — —
⚙️ | 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝗋𝗂𝗀𝗁𝗍𝗌 ANGEL 𝄮 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⌔┇ 𝗍𝖾𝖺𝗆 AnGeL ',url="https://t.me/HMBots"},
},
{
{text = '⌔┇ 𝖼𝗁‌ ANGEL ',url="https://t.me/HMBots"},
},
{
{text = '⌔┇ 𝖼𝗁 𝖽𝖾𝗏',url="t.me/eeeeeeB"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
↫︙رفع رسائل + العدد بالرد
↫︙رفع مجوهرات + العدد بالرد
 — — — — — — — — — 
[↫︙𝖢𝗁 𝖲𝗈𝖴𝗋𝖢𝖾](t.me/FxxFx)
]]
send(msg.chat_id_, msg.id_,Text)
