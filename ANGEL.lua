...
local NameUser = "[- Angel 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/HMBots)\n — — — — — — — — —\n↫︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Angel 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/HMBots)\n — — — — — — — — —\n↫︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- Angel 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/HMBots)\n — — — — — — — — —\n↫︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "HMBots")..")".."\n↫︙تم رفعه "..RTPA.." هنا\n")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Angel TeAM .',url="t.me/HMBots"}},
}
local msg_id = msg.id_/2097152/0.5
...
⌁︙[Exp Source](https://t.me/HMBots)

⌁︙[Developer](https://t.me/EEEEEEB)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws 𝖠𝖭𝖦𝖤𝖫](https://t.me/B82bot)
]]
send(msg.chat_id_, msg.id_,Text)
end
